...
/**
 * Receives server-push (unsolicited) messages — i.e. frames whose correlation ID
 * has no registered pending future in the CorrelationRegistry.
 * <p>
...
public class UnsolicitedMessageHandler {
    ...
    public void handle(PaymentTypes paymentType, String correlationId, byte[] payload) {
        log.info("Unsolicited message on pool='{}' corrId='{}' payloadBytes={}",
                paymentType, correlationId, payload.length);
    }
}
